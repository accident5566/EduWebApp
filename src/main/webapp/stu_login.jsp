...
<head>
  ...
  <script type="text/javascript" src="js/String2MD5.js"></script>
</head>
  ...
  <tr>
    <td align="center">
      <table width="525" border="0" cellspacing="0" cellpadding="0"
             background="/img/pic/login/bg-top.jpg">
        <tr>
          <td width="107">
            <img
                    src="/img/pic/login/top-left.jpg"
                    width="107" height="39">
          </td>
          <td width="256" class="adtitle">
            提供全新教务管理方案
          </td>
          ...
          <td width="10">
            <img
                    src="/img/pic/login/top-right.jpg"
                    width="15" height="39">
          </td>
        </tr>
      </table>
      ...
      <table border="0" cellspacing="0" cellpadding="0" class="mainbox">
        <tr>
                ...
                <tr>
                  <td>
                    ...
                    <table width="100%" border="0" cellspacing="6"
                           cellpadding="0" class="font-b">
                      <tr>
                        <td align="right" width="67">
                          <span id="userName_label">帐号</span>:
                        </td>
                        <td colspan="2">
                          <input type="text" name="zjh" value="" class="input01"
                                 title="帐号" alt="notnull">
                        </td>
                      </tr>
                      <tr>
                        <td align="right" width="67">
                        ...
                        <td colspan="2">
                          <input type="password" name="mm" value="" class="input01"
                                 title="密码" alt="notnull">
                        </td>
                      </tr>
                      <tr>
                        <td align="right" width="67">
                      ...
                      <tr>
                        <td align="right">
                          <input type="image" name=""
                                 ...
                                 border="0" onclick="login(); return false;" id="btnSure"
                                 class="buttonImg" title="登录">
                        </td>
                        <td align="center">
                          <input type="image" name=""
                                 src="/img/zh/reset.gif"
                                 border="0" onclick="reset(); return false"
                                 class="buttonImg" title="重设">
                        </td>
                        <td align="center">
                          <input type="image" name=""
                                 src="/img/zh/fpassword.gif"
                                 border="0" onclick="findPassword(); return false"
                                 class="buttonImg" title="密码找回">
          ...
          <td width="138" align="right" valign="bottom">
            <img src="/img/pic/login/stamp.jpg"
                 width="138" height="103">
          </td>
        </tr>
        <tr><td width="525" colspan="3" class="buildnumber" height="12" align="right"><font color="#555555">版本号：1.5_0</font></td></tr>
      </table>
      ...
      <table width="525" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="20">
            <img
                    src="/img/pic/login/bottom-left.jpg"
                    width="20" height="27">
          </td>
          <td width="490" class="bottom">
            版权所有 &copy; 2005-2008 北京清元优软科技有限公司 保留所有权利。
          </td>
          <td width="15">
            <img
                    src="/img/pic/login/bottom-right.jpg"
                    width="15" height="27">
          </td>
        </tr>
      </table>
